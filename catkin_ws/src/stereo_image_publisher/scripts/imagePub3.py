...
class image_converter(object):
  def __init__(self):
    ...
    print(self.leftCap.set(cv2.CAP_PROP_FRAME_WIDTH, 640))
    print(self.leftCap.set(cv2.CAP_PROP_FRAME_HEIGHT, 480))
    print(self.leftCap.set(cv2.CAP_PROP_FPS, fps))
    print(self.rightCap.set(cv2.CAP_PROP_FRAME_WIDTH, 640))
    print(self.rightCap.set(cv2.CAP_PROP_FRAME_HEIGHT, 480))
    print(self.rightCap.set(cv2.CAP_PROP_FPS, fps))
