...
"""autogenerated by genpy from camera_image_publisher/mono_camera.msg. Do not edit."""
import sys
...
class mono_camera(genpy.Message):
  _md5sum = "2d8c919282fd0c97beb37a985c1b60d2"
  _type = "camera_image_publisher/mono_camera"
...
bool do_rectify
"""
  __slots__ = ['header','Camera','CameraInfo']
  _slot_types = ['std_msgs/Header','sensor_msgs/Image','sensor_msgs/CameraInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mono_camera, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.Camera is None:
        self.Camera = sensor_msgs.msg.Image()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.Camera.height, _x.Camera.width))
      _x = self.Camera.encoding
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_BI().pack(_x.Camera.is_bigendian, _x.Camera.step))
      _x = self.Camera.data
      length = len(_x)
      ...
      _x = self
      buff.write(_get_struct_6IB().pack(_x.CameraInfo.binning_x, _x.CameraInfo.binning_y, _x.CameraInfo.roi.x_offset, _x.CameraInfo.roi.y_offset, _x.CameraInfo.roi.height, _x.CameraInfo.roi.width, _x.CameraInfo.roi.do_rectify))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.Camera.height, _x.Camera.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.Camera.encoding = str[start:end].decode('utf-8')
      else:
        self.Camera.encoding = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.Camera.is_bigendian, _x.Camera.step,) = _get_struct_BI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.Camera.data = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.CameraInfo.binning_x, _x.CameraInfo.binning_y, _x.CameraInfo.roi.x_offset, _x.CameraInfo.roi.y_offset, _x.CameraInfo.roi.height, _x.CameraInfo.roi.width, _x.CameraInfo.roi.do_rectify,) = _get_struct_6IB().unpack(str[start:end])
