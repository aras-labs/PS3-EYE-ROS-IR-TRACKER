...
// (in-package camera_image_publisher.msg)
...
class mono_camera {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('Camera')) {
        ...
        this.Camera = new sensor_msgs.msg.Image();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type mono_camera
    // Serialize message field [header]
    bufferOffset = std_msgs.msg.Header.serialize(obj.header, buffer, bufferOffset);
    // Serialize message field [Camera]
    bufferOffset = sensor_msgs.msg.Image.serialize(obj.Camera, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type mono_camera
    let len;
    let data = new mono_camera(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [Camera]
    data.Camera = sensor_msgs.msg.Image.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += sensor_msgs.msg.Image.getMessageSize(object.Camera);
  ...
  static datatype() {
    ...
    return 'camera_image_publisher/mono_camera';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '2d8c919282fd0c97beb37a985c1b60d2';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new mono_camera(null);
    ...
    if (msg.Camera !== undefined) {
      resolved.Camera = sensor_msgs.msg.Image.Resolve(msg.Camera)
    }
    else {
      resolved.Camera = new sensor_msgs.msg.Image()
    }
